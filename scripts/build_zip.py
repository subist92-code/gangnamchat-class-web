...
# 현행(2026-09-11 · 대장 §5 · 보강3 C2-072):
#   패키지 1 v1.0 · 패키지 2 **v1.1** · 패키지 3 **v1.1** · 패키지 4 v1.0
#   (2·3 의 v1.1 = 머리 라이선스 줄 기입 · 번역 원칙 T-10 · 3은 「【자리 · Q-6】」 정정)
PACKAGE_MAP = [
    ("01_진단값_프롬프트_v1_0_*.md", "01_진단값_프롬프트.md"),
    ("02_난이도_기준표_v1_1_*.md",   "02_난이도_기준표.md"),
    ("03_리포트_생성_규칙_v1_1_*.md", "03_리포트_생성_규칙.md"),
